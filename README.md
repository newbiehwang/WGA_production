...
- **역추적** (`GET /audit?trace=<actionId>&day=<YYYY-MM-DD>`, `services/llm/audit_trace.py`): 변경 작업 행의 옆 패널에서 '층별로 따져 보기'를 누르면, 그 작업을 놓고 아래에서 위로 묻습니다.
